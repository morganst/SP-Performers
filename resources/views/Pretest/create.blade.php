...
@section('content')
    ...
    {!! Form::open(['action' => 'PretestController@store', 'method' => 'POST','id'=>'myForm']) !!}
        <form>
        {{ Form::hidden('student_id', $student->id) }}
        <table style="width:100%">
                <tr>
                    <td width="55%">{!! Form::label('Q1', "How long have you been living in Jacksonville?", ['class' => 'col-lg-2 control-label'])!!}</td>
                    <td align="right">{{Form::label('year-1', '1 Year')}} {!! Form::radio('Q1', '1', false, array('id'=>'year-1'))!!}</td>
                    <td align="right">{{Form::label('year-2', '2 Years')}} {!! Form::radio('Q1', '2', false, array('id'=>'year-2'))!!}</td>
                    <td align="right">{{Form::label('year-3', '3 Years')}} {!! Form::radio('Q1', '3', false, array('id'=>'year-3'))!!}</td>
                    <td align="right">{{Form::label('year-4', '4 Years')}} {!! Form::radio('Q1', '4', false, array('id'=>'year-4'))!!}</td>
                    <td align="right">{{Form::label('year-5', '5+ Years')}} {!! Form::radio('Q1', '5', false, array('id'=>'year-5'))!!}</td>
                </tr>
                &nbsp;
                <tr>
                    ...
                    <td></td>
                    <td></td>
                    <td align="right">{{Form::label('yes', 'Yes ')}}{!! Form::radio('Q2', 'Yes', false, array('id'=>'yes'))  !!}</td>
                    <td align="right">{{Form::label('no', 'No ')}}{!! Form::radio('Q2', 'No', false, array('id'=>'no'))  !!}</td>
                </tr>
                &nbsp;
                <tr>
                    <td>{!! Form::label('Q3', "How many siblings do you have?", ['class' => 'col-lg-2 control-label'])!!}</td>
                    <td align="right">{{Form::label('sib', 'None ')}}{!! Form::radio('Q3', '0', false, array('id'=>'sib'))  !!}</td>
                    <td align="right">{{Form::label('sib-1', '1 ')}}{!! Form::radio('Q3', '1', false, array('id'=>'sib-1'))  !!}</td>
                    <td align="right">{{Form::label('sib-2', '2 ')}}{!! Form::radio('Q3', '2', false, array('id'=>'sib-2'))  !!}</td>
                    <td align="right">{{Form::label('sib-3', '3 ')}}{!! Form::radio('Q3', '3', false, array('id'=>'sib-3'))  !!}</td>
                    <td align="right">{{Form::label('sib-4', '4+ ')}}{!! Form::radio('Q3', '4+', false, array('id'=>'sib-4'))  !!}</td>
                </tr>
            </table>
            &nbsp;
            <table style="width:100%">
